  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="bg-[#003399] relative w-full h-96  text-white py-20 text-center">
        <div className=" backdrop-blur-md  absolute h-full flex drop-shadow-2xl flex-col justify-evenly w-full top-0 left-0 right-0 bottom-0 py-20 text-center z-10  ">
